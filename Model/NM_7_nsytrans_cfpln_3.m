...
inp.i = [1.65:-.05:ip ip*ones(1,idn)]; %  .3*ones(1,idn) 0.1*ones(1,200)
...
for xi = 1:floor(length(XS1)/10)
    ...
    prm.i = inp.i(xi*10); prm1.i = prm.i;
 ...
 tp1 = plot(XS1(1:10:(10*xi),1),XS1(1:10:(10*xi),2),'ko-',...
    ...
    xlabel('X1'); ylabel('X2');
    hold all
    plot(nco.nx,nco.y,'r--','linewidth',2)
    ...
    xlim([0 50]); xlabel('Time'); ylabel('Activity level')
        if ~exist('lp11','var')
        lp11 = plot(XS1(1:10:(10*xi),1),'r.-',...
            'markersize',12);
    else
        set(lp11,'YData',XS1(1:10:(10*xi),1))
    end
    if ~exist('lp12','var')
        lp12 = plot(XS1(1:10:(10*xi),2),'g.-',...
            'markersize',12);
    else
...
legend('X1','X2'); legend('boxoff')
    ...
    xlim([0 50]); xlabel('Time'); ylabel('Activity level')
    if ~exist('lp21','var')
        lp21 = plot(XS2(1:10:(10*xi),1),'r.-',...
            'markersize',12);
    else
        set(lp21,'YData',XS2(1:10:(10*xi),1))
    end
    if ~exist('lp22','var')
        lp22 = plot(XS2(1:10:(10*xi),2),'g.-',...
            'markersize',12);
    else
