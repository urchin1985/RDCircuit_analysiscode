function dxo = modfunsym(x1,x2,prm)
% parse params
...
% parse inputs
fc = inp.fc(ti); I = inp.i(ti);

syms x1 x2
dx1 = (1/tau1)*(-x1+fc*(b1+a1*sig(ki1,ni1,I))-be1*sig(k12,n12,x2));
dx2 = (1/tau2)*(-x2+b2+a2*sig(ki2,ni2,I)-be2*sig(k21,n21,x1)+r2*sig(k22,n22,x2));
