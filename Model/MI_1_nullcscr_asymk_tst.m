...
idn = 350; XS0=[0 1.1];
xr1 = [-1.5 7]; xr2 = xr1; inc = [.2 .2];
fid = 0; dq = 0;

prm.tau = [1 1];
prm.beta = 4.5*[1 1];%[5 4];
prm.k = -.5*[1 1];%[-.75 -1.75]; %prm.n(4)=2;
prm.n = 4*[1 1];%[1.6 2];
prm.b = [.9 -.25];%.2*[1 1]; % only asymmetry between X and Y
ilst = [0 .5 1];%0:.25:1.25;%0:.2:3;
il = (length(ilst));
