function xo = nmfun2(x1,x2,prm,icf)
% parse params
...
nx1 = tg*(fc*a1*sig(ki1,ni1,ic*I)+b1*sigflip(k12,n12,x2)+bs1);
nx2 = a2*sig(ki2,ni2,(1-icf+icf*(ic>0))*I)+b2*sigflip(k21,n21,x1)+bs2;

dx1 = (1/tau1)*(-x1+tg*(fc*a1*sig(ki1,ni1,ic*I)+b1*sigflip(k12,n12,x2)+bs1));
dx2 = (1/tau2)*(-x2+a2*sig(ki2,ni2,(1-icf+icf*(ic>0))*I)+b2*sigflip(k21,n21,x1)+bs2); % +r2*x2
% if (1-icf+icf*(ic>0)); oo;end
