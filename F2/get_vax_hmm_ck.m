...
load([savpath gtype '_alldata.mat'],'Cdat','Tdat','Vdat','Fdx','nsm_clust','vax_clust')
...
%%
if svon
save([savpath gtype '_alldata_613.mat'],'Cdat','Tdat','Vdat','Fdx','nsm_clust',...
    'vax_clust','Xd','clx','seqs','bstates','Bst','Bst2','Bnd','estTR','estE')
