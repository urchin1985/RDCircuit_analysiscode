...
tacm1 = nanmedian(tacr1);
taci1 = bootci(100,@nanmedian,tacr1);

tacmc = nanmedian(tacr_c);
tacic = bootci(100,@nanmedian,tacr_c);

bci = [taci1 tacic]; bmn = [tacm1 tacmc]; pclr = [.1 .1 1;1 1 1];
bbol = 1;
figure(102);clf;hold all
plot_bcibar([],bci,bmn,pclr,[],[],[],bbol)
plotstandard
